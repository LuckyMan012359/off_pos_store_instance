...
<body>
    ...
    <input type="hidden" id="currency_hidden"
        value="<?php echo escape_output($this->session->userdata('currency')); ?>">
    ...
    <input type="hidden" id="sms_enable_status"
        value="<?php echo escape_output($getCompanyInfo->sms_enable_status); ?>">
    ...
    <input type="hidden" id="other_search_place_holder_pos"
        value="<?php echo lang('other_search_place_holder_pos'); ?>">
    ...
    <input type="hidden" id="loyalty_rate"
        value="<?php echo escape_output($this->session->userdata('loyalty_rate')) ?>">
                ...
                <ul class="btn__menu">
                    ...
                    <li>
                        <div class="switchary_wrap"
                            <?php echo APPLICATION_MODE == 'demo' ? 'data-tippy-content="This button is disabled for demo. to check medicine shop experience please check medicine demo!"' : '' ?>>
                            <select id="grocery_experience_el" class="select2"
                                <?php echo APPLICATION_MODE == 'demo' ? 'disabled' : '' ?>>
                                <option value=""><?php echo lang('POS_Experience'); ?></option>
                                <option value="Regular"
                                    <?php echo $grocery_experience == 'Regular' ? 'selected' : '' ?>>
                                    <?php echo lang('Regular'); ?>
                                </option>
                                <option value="Medicine"
                                    <?php echo $grocery_experience == 'Medicine' ? 'selected' : '' ?>>
                                    <?php echo lang('Medicine'); ?>
                                </option>
                                <option value="Grocery"
                                    <?php echo $grocery_experience == 'Grocery' ? 'selected' : '' ?>>
                                    ...
                                    <select name="select_employee_id" id="select_employee_id" class="select2"
                                        ...
                                        foreach ($waiters as $value):
                                            if ($value->id != 1):
                                                ?>
                                        <option
                                            <?php echo escape_output($value->id) == $logedin_user ? 'selected' : '' ?>
                            ...
                            <div data-tippy-content="Keep Selected to Search By Genericname">
                                <label class="container op_color_dim_grey">
                                    <input class="generic_serch_option_checkbox" type="checkbox"
                                        name="generic_serch_option_checkbox"
                                        <?php echo $generic_name_search_option == 'Yes' ? 'checked' : '' ?>>
                ...
                <ul class="price_input_field op_margin_bottom_10">
                    ...
                    <li>
                        ...
                        <input tabindex="0" type="text" autocomplete="off" id="modal_item_price_input_field"
                            onfocus="select();" class="op_width_100_p op_center" value=""
                            <?php echo $sale_price_modify == 'No' ? 'readonly' : '' ?>>
                    </li>
                ...
                <div class="customer_section">
                    ...
                    <select class="form-control  select2 op_width_100_p" id="customer_group_id_modal"
                        ...
                        <option value="<?php echo escape_output($splrs->id) ?>"
                            <?php echo set_select('group_id', $splrs->id); ?>>
        ...
        <div class="modal-content">
            ...
            <div class="customedr_add_modal_info_holder">
                ...
                <label class="op_cursor_pointer op_padding_left_17">
                    <input <?= isset($qty_setting_check) && $qty_setting_check == "Yes" ? 'checked' : '' ?>
                        type="checkbox" name="qty_setting_check" value="Yes" id="qty_setting_check">
                                ...
                                <div class="item_modifier_details">
                                    <div class="bottom_total_calculation_hold footer-content-hold">
                                        ...
                                        <div class="item">
                                            ...
                                            <span>
                                                <span
                                                    id="sub_total_discount_hold"><?php echo getAmtPre(0) ?? 0 ?></span>
                ...
                <div class="payment_content_wrap finalize-p-inactive">
                    <div class="customer_previous_due_mobile op_mb_7">
                        <div class="finalize-mobile-view">
                            <p><b><?php echo lang('customer'); ?>:</b> <span class="finalize_mobile_customer"></span>
                            </p>
                    ...
                    <div class="sms-email-mobile d-flex justify-content-end my-20">
                        ...
                        <label class="container op_margin_top_6 op_color_dim_grey mr-10 send_sms_finalize">
                            ...
                            <input class="sms_enable_status" type="checkbox" name="send_invoice_sms"
                                <?php echo escape_output($getCompanyInfo->sms_enable_status) == "1" ? 'checked' : '' ?>>
                            <span class="checkmark"></span>
                        </label>
                        <label class="container op_margin_top_6 op_color_dim_grey  mr-10 send_email_finalize">
                            <?php echo lang('send_invoice_via_email'); ?>
                            <input class="smtp_enable_status" type="checkbox" name="send_invoice_email"
                                <?php echo escape_output($getCompanyInfo->smtp_enable_status) == "1" ? 'checked' : '' ?>>
                            <span class="checkmark"></span>
                        </label>
                        ...
                        <label class="container op_margin_top_6 op_color_dim_grey send_wm_finalize">
                            ...
                            <input class="send_invoice_whatsapp" type="checkbox" name="send_invoice_whatsapp"
                                <?php echo escape_output($getCompanyInfo->whatsapp_invoice_enable_status) == "Enable" ? 'checked' : '' ?>>
                            <span class="checkmark"></span>
                        </label>
                        <?php } ?>
                    </div>
            ...
            <div class="main-content-wrapper">
                <div class="form-group mt-3">
                    ...
                    <select id="charge_type" class="select2">
                        <option
                            <?php echo isset($sale_item) && $sale_item->charge_type == "delivery" ? 'selected' : '' ?>
                            value="delivery"><?php echo lang('delivery'); ?></option>
                        <option
                            <?php echo isset($sale_item) && $sale_item->charge_type == "service" ? 'selected' : '' ?>
